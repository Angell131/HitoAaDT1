...
public class HitoPostgres {
    ...
    public static void main(String[] args) {
        ...
        String cadenaConexion = "jdbc:postgresql://localhost/juegos";
    ...
    public static void importarP() {

        try{
            //CREAMOS EL FICHERO DONDE GUARDAREMOS LOS DATOS.
            PrintWriter pw= new PrintWriter(new File("datos_PostgreSql.csv"));
    ...
    public static void copiaP(){
        try {
            //COPIA DE SEGURIDAD.
            //CREAMOS EL FICHERO DONDE GUARDAREMOS LOS DATOS.
            PrintWriter pw= new PrintWriter(new File("copiaSeguridadPostgreSqlJuegos.csv"));
            //UTILIZAMOS UN OBJETO StringBuilder PARA ALMACENAR CADENAS DE TEXTO.
            StringBuilder sb=new StringBuilder();
